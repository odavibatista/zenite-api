...
export class InventoryRepository implements InventoryRepositoryInterface {
  async findAll(): Promise<FindAllInventoriesDto[]> {
    ...
    return inventories.map((inventory) => ({
      ...
      productExpirationDate: inventory.product.expirationDate.toISOString(),
      ...
      monthlyStorageCost: Number(inventory.monthlyStorageCost),

      isCritical: inventory.quantity < inventory.product.minimumStock,

      isExpired: inventory.product.expirationDate < new Date(),
